# Dự án Chuyển đổi MRI thành CT mô phỏng sử dụng CycleGAN
...
**Lý do chọn Z-score**:
- **Robust**: Không bị ảnh hưởng bởi outliers như Min-Max normalization
- **Preserves relative relationships**: Giữ nguyên mối quan hệ tương đối giữa các pixel
- **Medical imaging standard**: Phù hợp với đặc tính của ảnh y học

**Clipping về [-3, 3]**:
- Loại bỏ extreme outliers (>3 standard deviations)
- Tránh gradient explosion trong training
